      ...
      {cListStatus === "OFF" && (
        <div className="aright">
          ...
          <div className="con2">
            ...
            <div className="acard" style={{backgroundColor: "blue"}} onClick={() => handleOpenList("departmental")}>
              <div className="cr">
                <p className="cp"> DEPARTMENTAL COMPLAINTS </p>
                <p className="cv">
                  view
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="acard" style={{backgroundColor: "orange"}} onClick={() => handleOpenList("history")}>
              <div className="cr">
                <p className="cp">FORWARDED/RESOLVED COMPLAINTS HISTORY</p>
                <p className="cv">
                  view
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
