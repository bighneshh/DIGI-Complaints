...
function LoginAdmin() {
  ...
  const handleForgot = () => {
    localStorage.setItem("forgotUserType", "Admin");
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("Admin not verified or Invalid Credentials");
    } finally {
      ...
      <div className="container">
        <form method="POST" action="#" onSubmit={handleSubmit}>
          ...
          <div className="remember-forgot">
            ...
            <Link onClick={handleForgot} to="/forgot-password">
              Forgot password?
            </Link>{" "}
          </div>
