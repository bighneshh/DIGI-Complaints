...
function LoginHOD() {
  ...
  const handleForgot = () => {
    localStorage.setItem('forgotUserType', "HOD");
  }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("typeUser", "HOD");
      navigate("/HODDashboard");
    } catch (error) {
      console.error("Login error:", error);
      alert("HOD not verified or Invalid Credentials");
    } finally {
    ...
    <div className="login-page">
      ...
      <div className="container">
        <form method="POST" action="#" onSubmit={handleSubmit}>
          <div className="title">HOD Login</div>
