    ...
    <div className="amain">
      <div className="aleft">
        ...
        <div className="details">
          ...
          {typeUser === "Admin" && (
            <p onClick={() => setCListStatus("userManagement")}>
              Users and Feedback
            </p>
          )}
          {typeUser === "HOD" && (
            <p onClick={() => navigate("/hodDashboard")}>HOD Dashboard</p>
          )}
          {typeUser === "PIC" && (
            <p onClick={() => navigate("/PICDashboard")}>PIC Dashboard</p>
          )}
          {typeUser === "Vendor" && (
            <p onClick={() => navigate("/vendorDashboard")}>Vendor Dashboard</p>
          )}
          {typeUser === "Principal" && (
            <p onClick={() => navigate("/principalDashboard")}>
              Principal Dashboard
            </p>
          )}
          <div className="drop">
            ...
            {isOpen && (
              <div
                className="dc"
                style={{ ...dropdownContainerStyle, ...dropdownStyle }}
              >
                <p
                  style={{
                    ...optionStyle,
                    listStyleType: "disc", // Add bullet style
                    "&:hover": {
        ...
        <div className="aright">
          ...
          <div className="con2">
            ...
            <div
              ...
              onClick={() => handleOpenList("resolved")}
            >
              <div className="cr">
            ...
            <div
              ...
              onClick={() => handleOpenList("reverted")}
            >
              <div className="cr">
            ...
            <div
              ...
              onClick={() => handleOpenList("declined")}
            >
              <div className="cr">
      ...
      {cListStatus === "ON" && (
        <ComplaintListUser
          userType={typeUser}
          status={status}
          listOff={handleListOff}
        />
      )}
      {cListStatus === "HELP" && <HelpListUser listOff={handleListOff} />}
    </div>
  );
};
