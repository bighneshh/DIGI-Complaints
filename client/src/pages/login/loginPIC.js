...
function LoginPIC() {
  ...
  const handleForgot = () => {
    localStorage.setItem('forgotUserType', "PIC");
  }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("typeUser", "PIC");
      navigate("/PICDashboard");
    } catch (error) {
      console.error("Login error:", error);
      alert("PIC not verified or Invalid Credentials");
    } finally {
    ...
    <div className="login-page">
      ...
      <div className="container">
        <form method="POST" action="#" onSubmit={handleSubmit}>
          <div className="title">PIC Login</div>
